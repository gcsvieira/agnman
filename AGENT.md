...
### Rule: Context-First Orientation
1. **Source of Truth:** Before starting any new task, read `MAP.md` to understand the project structure and `AGENT.md` to align with the project's specific operational directives.
